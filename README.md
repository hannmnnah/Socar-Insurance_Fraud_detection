...
### - 배경  : 
- __렌터카 보험사기 피해금액 8,090억원?__  
	
	렌터카 보험사기란 보험금, 합의금을 얻을 목적으로 렌터카를 이용하여 고의 사고를 내는 행위입니다. 2016년부터 꾸준히 8만여명씩 적발되다가 , 지난 2019년에는 9.3만명으로 역대 최고치 기록(출처:금융감독원, 보험 사기 전체 기준)하였습니다. 적발 금액은 2019년 기준 8,090억원으로 피해액이 상당합니다.  
